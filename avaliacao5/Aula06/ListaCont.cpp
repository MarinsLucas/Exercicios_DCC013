...
{
    int i, j = 0;  //variáveis para contagem
    int *vetAux = new int[n]; //criando um vetor auxiliar com n posições (do mesmo tamanho da lista)
    ...
    if(j==0)
        return NULL; //não havendo nenhum par, retorna-se NULL
